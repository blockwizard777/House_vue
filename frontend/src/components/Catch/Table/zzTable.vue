  ...
  <div>
    ...
    <div class="app-container" style="margin: 3px 5px;">
      ...
      <div class="filter-container">
        ...
        <el-button v-if="this.selectedIds.length > 0 && hidePagination" type="danger" size="small"
...
<!--          <el-button v-if="this.selectedIds.length > 0" icon="el-icon-delete" style="float: left" type="danger"-->
<!--                     size="small" @click="handleDelete(selectedIds)">批量删除-->
<!--          </el-button>-->
<!--        </el-col>-->
        <el-col :span="16">
          <el-pagination
...
<script>
  ...
  import operate from './zzMixinOperate'
  ...
  export default {
    name: 'Table',
    mixins: [operate, create, update, del, props, view, to, _export, excel, tableData],
    // props: {
    //   ...Tool.createObject(props.props),
    //   selectable: {
    //     type: Boolean,
    //     default: false,
    //   }
    ...
    methods: {
      ...
      handleShowDialog(data = null, create = false) {
        this.$emit('onZZTableUpdate', data)
