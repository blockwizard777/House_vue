<template>
  <div>
    ...
    <div class="" @drop="handleDrop" @dragover="handleDragover" @dragenter="handleDragover">
<!--      {{bLoadSuccess ? fileName : '将文件拖到此处，或'}}-->
      <el-row style="display: flex;">
        <i style="margin:0 auto;display: block;font-size: 60px;color: green;" class="el-icon-folder-opened" />
      </el-row>
      <el-row>
        <el-button :loading="loading" style="margin:0 auto;display: block;" size="mini" type="info" @click="handleUpload">
          选择文件
        </el-button>
      </el-row>
    </div>
